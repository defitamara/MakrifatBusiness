        ...
        <div class="page-breadcrumb">
          <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
              <h4 class="page-title">Form Edit Data Yayasan</h4>
          ...
          {{-- <div class="row"> --}}
            {{-- <div class="col-md-6"> --}}
              <div class="card">
                ...
                action="{{ route('data_yayasan.update',$data_yayasan->id) }}">
                
                {{-- Code untuk menyimpan --}}
                {!! csrf_field() !!}
                {{-- Code untuk cek apakah ada artikel yang dipilih untuk diedit --}}
                {!! isset($data_yayasan) ? method_field('PUT') : '' !!}

                {{-- Inputtan tak terlihat --}}
                <input type="hidden" name="id" value="{{ isset($data_yayasan) ? $data_yayasan->id : '' }}">
                {{-- <input type="hidden" name="tanggal" value="{{ date('Y-m-d') }}"> --}}

                  <div class="card-body">
                    <div class="card-title">
                      <a href="/dashboard">Dashboard / </a>
                      <a href="/data_yayasan">Data Yayasan / </a>
                      Edit Data
                    </div>
                    <div class="form-group row">
                      ...
                      <div class="col-sm-13">
                        <input
                          ...
                          value="{{ isset($data_yayasan) ? $data_yayasan->judul : '' }}"/>
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-13">
                        <input
                          ...
                          value="{{ isset($data_yayasan) ? $data_yayasan->jumlah : '' }}"/>
                      </div>
                    </div>
                  ...
                  <div class="border-top">
                    <div class="card-body float-end">
                      <a href="/data_yayasan"><button type="button" class="btn btn-secondary">BATAL</button></a>
