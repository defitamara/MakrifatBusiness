        ...
        <div class="page-breadcrumb">
          <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
              <h4 class="page-title">Form Edit Data Tentang Kami</h4>
          ...
          {{-- <div class="row"> --}}
            {{-- <div class="col-md-6"> --}}
              <div class="card">
                ...
                action="{{ route('data_tk.update',$tk->id) }}">
                
                {{-- Code untuk menyimpan --}}
                {!! csrf_field() !!}
                {{-- Code untuk cek apakah ada data yang dipilih untuk diedit --}}
                {!! isset($tk) ? method_field('PUT') : '' !!}

                {{-- Inputtan tak terlihat --}}
                <input type="hidden" name="id" value="{{ isset($tk) ? $tk->id : '' }}">
                {{-- <input type="hidden" name="tanggal" value="{{ date('Y-m-d') }}"> --}}

                  <div class="card-body">
                    <div class="card-title">
                      <a href="/dashboard">Dashboard / </a>
                      <a href="/data_tk">Tentang Kami / </a>
                      Edit Data
                    </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-13">
                        <div class="custom-file">
                          <input type="hidden" name="nama_gambar" value="{{ isset($tk) ? $tk->gambar : '' }}">
                          <td><img src="/data/data_tk/{{ isset($tk) ? $tk->gambar : '' }}" width="100"></td>
                          <input
                            type="file"
                    ...
                    <div class="form-group row">
                      ...
                      >
                      <div class="col-sm-13">
                        <textarea class="ckeditor" id="deskripsi" name="deskripsi">{!! isset($tk) ? $tk->deskripsi : '' !!}</textarea>
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-sm-3">
                      ...
                      <div class="col-md-13">
                        <div class="custom-file">
                          <input type="hidden" name="nama_gambar2" value="{{ isset($tk) ? $tk->foto_pemilik : '' }}">
                          <td><img src="/data/data_tk/{{ isset($tk) ? $tk->foto_pemilik : '' }}" width="100"></td>
                          <input
                            type="file"
                            id="gambar2" name="gambar2"
                            class="custom-file-input {{ $errors->has('gambar2') ? 'is-invalid' : ''}}"
                          />
                          @if ( $errors->has('gambar2'))
                            <span class="text-danger small">
                              <p>{{ $errors->first('gambar2') }}</p>
                            </span>
                          @endif
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-13">
                        <input
                          ...
                          value="{{ isset($tk) ? $tk->nama_pemilik : '' }}"/>
                      </div>
                    </div>
                    <div class="form-group row">
                      <label
                      ...
                      <div class="col-sm-13">
                        <input
                          ...
                          value="{{ isset($tk) ? $tk->jabatan : '' }}"/>
                      </div>
                    </div>
                  </div>
                  <div class="border-top">
                    <div class="card-body float-end">
                      <a href="/data_tk"><button type="button" class="btn btn-secondary">BATAL</button></a>
