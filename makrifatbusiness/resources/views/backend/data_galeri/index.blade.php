        ...
        <div class="page-breadcrumb">
          <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
              <h4 class="page-title">Daftar Galeri</h4>
          ...
          <!-- ============================================================== -->
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <a href="{{ route('data_galeri.create') }}" class="card-title">
                    ...
                    >
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>{{ $no++ }}</td>
                          <td>{{ $item->judul }}</td>
                          <td><img src="/data/data_galeri/{{ $item->gambar }}" width="100"></td>
                          <td>
                            <a href="{{ route('data_galeri.edit',$item->id) }}" >
                              <button type="button" class="btn btn-cyan btn-sm text-white">
                              <span class="fas fa-pencil-alt"></span>
                            </button></a>
                          
                          <form action="{{ route('data_galeri.destroy',$item->id)}}" method="POST">
                            @csrf
                                @method('DELETE')
                                <button type="submit" class="btn btn-danger btn-sm text-white" 
                                onclick="return confirm('Apakah Anda yakin ingin menghapus galeri {{ $item->judul }} ini?')">
