                    ...
                    >
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>{!! \Illuminate\Support\Str::limit($item->isi , 100) !!} <a href="/data_artikel/{{ $item->id_artikel }}/detail" class="more-btn">  <strong> Read more » </strong></td>
                          <td>{{ $item->kategori_artikel }}</td>
                          <td>{{ \Carbon\Carbon::parse($item->updated_at)->diffForHumans() }}</td>
                          {{-- <td>{{ \Carbon\Carbon::parse($item->updated_at)->translatedFormat('l, d F Y H:i:s') }}</td> --}}
                          <td>
