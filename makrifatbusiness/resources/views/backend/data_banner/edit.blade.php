        ...
        <div class="page-breadcrumb">
          <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
              <h4 class="page-title">Form Edit Data Banner</h4>
          ...
          {{-- <div class="row"> --}}
            {{-- <div class="col-md-6"> --}}
              <div class="card">
                ...
                action="{{ route('data_banner.update',$banner->id) }}">
                ...
                {{-- <input type="hidden" name="tanggal" value="{{ date('Y-m-d') }}"> --}}
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-13">
                        <input
                          type="text"
                          class="form-control"
                          id="judul_kecil" name="judul_kecil"
                          placeholder="Masukkan judul yang akan tampil kecil"
                          value="{{ isset($banner) ? $banner->judul_kecil : '' }}"/>
                      </div>
                    </div>
                    <div class="form-group row">
                      <label
                      ...
                      <div class="col-sm-13">
                        <input
                          type="text"
                          class="form-control"
                          id="judul_besar" name="judul_besar"
                          placeholder="Masukkan judul yang akan tampil besar"
                          value="{{ isset($banner) ? $banner->judul_besar : '' }}"/>
                      </div>
                    </div>
                    <div class="form-group row">
                      ...
                      <div class="col-md-13">
                        <div class="custom-file">
                          ...
                          <td><img src="/data/data_banner/{{ isset($banner) ? $banner->gambar : '' }}" width="200"></td>
                          <input
                            type="file"
                  ...
                  <div class="border-top">
                    <div class="card-body float-end">
                      <a href="/data_banner"><button type="button" class="btn btn-secondary">BATAL</button></a>
