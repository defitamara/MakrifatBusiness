        ...
        <div class="page-breadcrumb">
          <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
              <h4 class="page-title">Daftar Banner Header</h4>
                  ...
                  <div class="table-responsive">
                    ...
                    >
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>{{ $no++ }}</td>
                          <td>{{ $item->judul_kecil }}</td>
                          <td>{{ $item->judul_besar }}</td>
                          <td colspan="3"><img src="/data/data_banner/{{ $item->gambar }}" width="300"></td>
                          <td>
                            <a href="{{ route('data_banner.edit',$item->id) }}" >
                              <button type="button" class="btn btn-cyan btn-sm text-white">
                              <span class="fas fa-pencil-alt"></span>
                            </button></a>
                          
                          <form action="{{ route('data_banner.destroy',$item->id)}}" method="POST">
                            @csrf
                                @method('DELETE')
                                <button type="submit" class="btn btn-danger btn-sm text-white" 
                                onclick="return confirm('Apakah Anda yakin ingin menghapus banner {{ $item->judul }} ini?')">
