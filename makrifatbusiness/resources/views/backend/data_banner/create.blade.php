        ...
        <div class="page-breadcrumb">
          <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
              <h4 class="page-title">Form Tambah Data Banner</h4>
          ...
          {{-- <div class="row"> --}}
            {{-- <div class="col-md-6"> --}}
              <div class="card">
                ...
                action="{{ route('data_banner.store') }}">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-13">
                        <input
                          ...
                          placeholder="Masukkan judul yang akan tampil kecil" required/>
                      </div>
                    </div>
                    <div class="form-group row">
                      <label
                      ...
                      <div class="col-sm-13">
                        <input
                          ...
                          placeholder="Masukkan judul yang akan tampil besar" required/>
                      </div>
                    </div>
                    <div class="form-group row">
