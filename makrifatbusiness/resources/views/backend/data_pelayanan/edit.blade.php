        ...
        <div class="page-breadcrumb">
          <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
              <h4 class="page-title">Form Edit Data Pelayanan</h4>
          ...
          {{-- <div class="row"> --}}
            {{-- <div class="col-md-6"> --}}
              <div class="card">
                ...
                action="{{ route('data_pelayanan.update',$pelayanan->id) }}">
                
                {{-- Code untuk menyimpan --}}
                {!! csrf_field() !!}
                {{-- Code untuk cek apakah ada artikel yang dipilih untuk diedit --}}
                {!! isset($pelayanan) ? method_field('PUT') : '' !!}

                {{-- Inputtan tak terlihat --}}
                <input type="hidden" name="id" value="{{ isset($pelayanan) ? $pelayanan->id : '' }}">
                {{-- <input type="hidden" name="tanggal" value="{{ date('Y-m-d') }}"> --}}

                  <div class="card-body">
                    <div class="card-title">
                      <a href="/dashboard">Dashboard / </a>
                      <a href="/data_pelayanan">Pelayanan / </a>
                      Edit Data
                    </div>
                    <div class="form-group row">
                      ...
                      <div class="col-sm-13">
                        <input
                          ...
                          value="{{ isset($pelayanan) ? $pelayanan->judul : '' }}"/>
                      </div>
                    </div>
            
                    <div class="form-group row">
                      <label class="col-sm-3">
                        Gambar Pelayanan</label>
                      <div class="col-md-13">
                        <div class="custom-file">
                          <input type="hidden" name="nama_gambar" value="{{ isset($pelayanan) ? $pelayanan->gambar : '' }}">
                          <td><img src="/data/data_pelayanan/{{ isset($pelayanan) ? $pelayanan->gambar : '' }}" width="200"></td>
                          <input
                            type="file"
                  ...
                  <div class="border-top">
                    <div class="card-body float-end">
                      <a href="/data_pelayanan"><button type="button" class="btn btn-secondary">BATAL</button></a>
