        ...
        <div class="page-breadcrumb">
          <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
              <h4 class="page-title">Daftar Tim</h4>
          ...
          <!-- ============================================================== -->
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <a href="{{ route('data_tim.create') }}" class="card-title">
                    ...
                    >
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>{{ $item->nama }}</td>
                          <td>{{ $item->jabatan }}</td>
                          <td><img src="/data/data_tim/{{ $item->foto }}" width="100"></td>
                          <td>{{ $item->link_facebook }}</td>
                          <td>{{ $item->link_twitter }}</td>
                          <td>{{ $item->link_instagram }}</td>
                          <td>
                            <a href="{{ route('data_tim.edit',$item->id) }}" >
                              <button type="button" class="btn btn-cyan btn-sm text-white">
                              <span class="fas fa-pencil-alt"></span>
                            </button></a>
                          
                          <form action="{{ route('data_tim.destroy',$item->id)}}" method="POST">
                            @csrf
                                @method('DELETE')
                                <button type="submit" class="btn btn-danger btn-sm text-white" 
                                onclick="return confirm('Apakah Anda yakin ingin menghapus tim {{ $item->nama }} ini?')">
