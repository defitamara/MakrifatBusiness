        ...
        <div class="page-breadcrumb">
          <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
              <h4 class="page-title">Daftar Data Keunggulan</h4>
                  ...
                  <div class="table-responsive">
                    ...
                    >
                      ...
                      <tbody>
                        ...
                        @php $no = 1; @endphp
                        @foreach ($data_keunggulan as $item)
                        <tr>
                          <td>{{ $no++ }}</td>
                          <td>{{ $item->judul }}</td>
                          <td>{{ $item->deskripsi }}</td>
                          <td>{{ $item->kompetensi_1 }}</td>
                          <td>{{ $item->kompetensi_2 }}</td>
                          <td>{{ $item->kompetensi_3 }}</td>
                          <td>{{ $item->persentase_1 }}</td>
                          <td>{{ $item->persentase_2 }}</td>
                          <td>{{ $item->persentase_3 }}</td>
                          <td><img src="/data/data_keunggulan/{{ $item->gambar }}" width="100"></td>
                          <td>
                            <a href="{{ route('data_keunggulan.edit',$item->id_keunggulan) }}" >
